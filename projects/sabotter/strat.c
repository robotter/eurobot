...
#define PATHFINDING_GRAPH_NODE_CENTRAL_STOCK_TOP   PATHFINDING_GRAPH_NODE_TEAM_SIDE(CENTRAL_STOCK_TOP, BLUE, YELLOW)
#define PATHFINDING_GRAPH_NODE_CENTRAL_STOCK_BOT   PATHFINDING_GRAPH_NODE_TEAM_SIDE(CENTRAL_STOCK_BOT, BLUE, YELLOW)
