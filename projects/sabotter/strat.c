...
#define PATHFINDING_GRAPH_NODE_RAMP_ENTRANCE  PATHFINDING_GRAPH_NODE_TEAM_SIDE(RAMP_ENTRANCE, YELLOW, BLUE)
#define PATHFINDING_GRAPH_NODE_SMALL_DISPENSER  PATHFINDING_GRAPH_NODE_TEAM_SIDE(SMALL_DISPENSER, YELLOW, BLUE)
#define PATHFINDING_GRAPH_NODE_LARGE_DISPENSER_NEAR  PATHFINDING_GRAPH_NODE_TEAM_SIDE(LARGE_DISPENSER_NEAR, YELLOW, BLUE)
#define PATHFINDING_GRAPH_NODE_LARGE_DISPENSER_FAR  PATHFINDING_GRAPH_NODE_TEAM_SIDE(LARGE_DISPENSER_FAR, YELLOW, BLUE)
#define PATHFINDING_GRAPH_NODE_GOLDENIUM  PATHFINDING_GRAPH_NODE_TEAM_SIDE(GOLDENIUM, BLUE, YELLOW)
#define PATHFINDING_GRAPH_NODE_ACCELERATED_BLUE  PATHFINDING_GRAPH_NODE_TEAM_SIDE(ACCELERATED_BLUE, BLUE, YELLOW)
#define PATHFINDING_GRAPH_NODE_BALANCE  PATHFINDING_GRAPH_NODE_TEAM_SIDE(BALANCE, YELLOW, BLUE)
#define PATHFINDING_GRAPH_NODE_GALIPETTE_START  PATHFINDING_GRAPH_NODE_TEAM_SIDE(GALIPETTE_START, YELLOW, BLUE)
#define PATHFINDING_GRAPH_NODE_RED_AREA  PATHFINDING_GRAPH_NODE_TEAM_SIDE(RED_AREA, YELLOW, BLUE)
