...
team_t strat_select_team(void)
{
  ...
  if(team == TEAM_YELLOW) {
    ...
    ROME_LOG(ROME_DST_PADDOCK, INFO, "Color : BLUE !");
  }
...
#define PATHFINDING_GRAPH_NODE_BACKSTAGE           PATHFINDING_GRAPH_NODE_TEAM_SIDE(BACKSTAGE        , YELLOW, BLUE)
#define PATHFINDING_GRAPH_NODE_MAIN_START          PATHFINDING_GRAPH_NODE_TEAM_SIDE(MAIN_START       , YELLOW, BLUE)
#define PATHFINDING_GRAPH_NODE_ALT_START           PATHFINDING_GRAPH_NODE_TEAM_SIDE(ALT_START        , YELLOW, BLUE)
#define PATHFINDING_GRAPH_NODE_RESERVED_STOCK      PATHFINDING_GRAPH_NODE_TEAM_SIDE(RESERVED_STOCK   , YELLOW, BLUE)
#define PATHFINDING_GRAPH_NODE_MAIN_CENTRAL_STOCK_TOP   PATHFINDING_GRAPH_NODE_TEAM_SIDE(CENTRAL_STOCK_TOP, YELLOW, BLUE)
#define PATHFINDING_GRAPH_NODE_MAIN_CENTRAL_STOCK_BOT   PATHFINDING_GRAPH_NODE_TEAM_SIDE(CENTRAL_STOCK_BOT, YELLOW, BLUE)
#define PATHFINDING_GRAPH_NODE_AUX_CENTRAL_STOCK_TOP   PATHFINDING_GRAPH_NODE_TEAM_SIDE(CENTRAL_STOCK_TOP, BLUE, YELLOW)
#define PATHFINDING_GRAPH_NODE_AUX_CENTRAL_STOCK_BOT   PATHFINDING_GRAPH_NODE_TEAM_SIDE(CENTRAL_STOCK_BOT, BLUE, YELLOW)
#define PATHFINDING_GRAPH_NODE_SIDE_STOCK_TOP      PATHFINDING_GRAPH_NODE_TEAM_SIDE(SIDE_STOCK_TOP   , YELLOW, BLUE)
#define PATHFINDING_GRAPH_NODE_SIDE_STOCK_BOT      PATHFINDING_GRAPH_NODE_TEAM_SIDE(SIDE_STOCK_BOT   , YELLOW, BLUE)
#define PATHFINDING_GRAPH_NODE_BOT_STOCK           PATHFINDING_GRAPH_NODE_TEAM_SIDE(BOT_STOCK        , YELLOW, BLUE)
#define PATHFINDING_GRAPH_NODE_CONSTRUCTION_AREA   PATHFINDING_GRAPH_NODE_TEAM_SIDE(CONSTRUCTION_AREA, YELLOW, BLUE)
