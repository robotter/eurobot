...
add_graph('pathfinding_graph', {
  ...
  'orange_midh orange_midl orange_bot',
  'green_midh green_midl green_bot',
  ...
  #diagonals
  'green_water_tower           d green_midh g middle_midl orange_bot',
  ...
  'orange_water_tower          a orange_midh f middle_midl green_bot',
