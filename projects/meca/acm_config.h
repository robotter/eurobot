...
#define ACM_AX12_MAX_TRIES            3
#define ACM_AX12_ORDER_TIMEOUT_US     200000
...
#define DEFAULT_ACM_SECOND_LVL_BLOW_LAST_RED_CANDLE   280
...
#define DEFAULT_ACM_FIRST_LVL_LEFT_BLOW_CANDLE_POS  820
#define DEFAULT_ACM_FIRST_LVL_LEFT_AVOID_CANDLE_POS 710

#define DEFAULT_ACM_FIRST_LVL_RIGHT_HOME_POS         490
#define DEFAULT_ACM_FIRST_LVL_RIGHT_BLOW_CANDLE_POS  195
#define DEFAULT_ACM_FIRST_LVL_RIGHT_AVOID_CANDLE_POS 300


// distances of arm to encoder
#define DEFAULT_ACM_SECOND_LVL_ARM_ENC_OFFSET_MM        40.0
#define DEFAULT_ACM_SECOND_LVL_ARM_RED_SIDE_AVOID_RED_CANDLE_POS_OFFSET_MM        70.0
#define DEFAULT_ACM_SECOND_LVL_ARM_BLUE_SIDE_AVOID_BLUE_CANDLE_POS_OFFSET_MM        90.0
...
#define ACM_ANTICIPATION_ACTIVATION_THRESHOLD   10 // in encoder units
