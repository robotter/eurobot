...
#define DEFAULT_SECOND_LVL_RED_ROBOT_STALL_BLUE_SIDE_BLOW_LAST_CANDLE_OFFSET_MM 130.0
#define DEFAULT_ACM_FIRST_LVL_LEFT_ARM_ENC_OFFSET_MM    100.0
#define DEFAULT_ACM_FIRST_LVL_RIGHT_ARM_ENC_OFFSET_MM   80.0
...
#define DEFAULT_ACM_CAM_UPDATE_CANDLE_WINDOW_MM   15.0

#define DEFAULT_ACM_COLOR_VALID_THRESHOLD 2
