...
void motors_init(void)
{
  ...
  // PWMs
  pwm_motor_init(&motor_left.pwm, &MOTOR_RIGHT_PWM_TC, MOTOR_LEFT_PWM_CH, motor_left_set_sign);
  pwm_motor_init(&motor_right.pwm, &MOTOR_RIGHT_PWM_TC, MOTOR_RIGHT_PWM_CH, motor_right_set_sign);
