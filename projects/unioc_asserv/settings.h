...
// --
#define SETTING_PID_MOTOR0_GAIN_P (4096)
#define SETTING_PID_MOTOR0_GAIN_I (0)
#define SETTING_PID_MOTOR0_GAIN_D (0)

#define SETTING_PID_MOTOR0_MAX_IN  (50000)
#define SETTING_PID_MOTOR0_MAX_I   (1000)
#define SETTING_PID_MOTOR0_MAX_OUT (32767)

#define SETTING_PID_MOTOR0_SHIFT (12)

// --

#define SETTING_PID_MOTOR1_GAIN_P (4096)
#define SETTING_PID_MOTOR1_GAIN_I (0)
#define SETTING_PID_MOTOR1_GAIN_D (0)

#define SETTING_PID_MOTOR1_MAX_IN  (50000)
#define SETTING_PID_MOTOR1_MAX_I   (1000)
#define SETTING_PID_MOTOR1_MAX_OUT (32767)

#define SETTING_PID_MOTOR1_SHIFT (12)

// -- 

#define SETTING_PID_MOTOR2_GAIN_P (4096)
#define SETTING_PID_MOTOR2_GAIN_I (10)
#define SETTING_PID_MOTOR2_GAIN_D (0)

#define SETTING_PID_MOTOR2_MAX_IN  (50000)
#define SETTING_PID_MOTOR2_MAX_I   (1000)
#define SETTING_PID_MOTOR2_MAX_OUT (32767)

#define SETTING_PID_MOTOR2_SHIFT (12)
