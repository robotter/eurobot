...
static const float motor_encoders_scales[] = {1.0, 1.0, 1.0};
#elif defined(GALIPETTE)
#define M (1.0)
#define N (2.0)
static const float motors_scales[] = {M*2, M*1.0, M*1.0};
static const float motor_encoders_scales[] = {-0.5*N, 1.0*N, 1.0*N};
#else
